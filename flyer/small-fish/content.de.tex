...
\renewcommand{\rulesTitle}{%
	\noindent%
	\color{primary}\setbox\formbox\hbox{\addfontfeature{LetterSpace=-3.5}GESTATTEN,\,}\usebox\formbox%
...
\renewcommand{\rulesURL}{\href{http://ludus-leonis.com/nipajin}{LUDUS-LEONIS.COM}}

% --- back page ----------------------------------------------------------------

\renewcommand{\settingTitle}{%
	\noindent%
	\color{primary}\setbox\formbox\hbox{\parbox[b]{6cm}{\fontsize{11.5pt}{14pt}\selectfont\addfontfeature{LetterSpace=-3.0}„Eines Tages, vielleicht auch nie, werde \\ich dich bitten, diesen Flyer zu spielen.“}}\usebox\formbox%
	\color{white}\fffancy\makebox[\dimexpr\linewidth-\wd\formbox\relax][l]{\expandafter\spaceout{FLYER}} \par%
	\noindent%
	\makebox[\linewidth][l]{\spaceout{ROLLENSPIEL!}} \par%
}
...
\renewcommand{\settingText}{%
	\noindent
	Dieses Szenario ist für 2 bis 6 Charaktere ausgelegt und nutzt die Regeln von der anderen Seite.
