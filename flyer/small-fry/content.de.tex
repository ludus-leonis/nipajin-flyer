...
\renewcommand{\flyerVersion}{v1.1}
...
\renewcommand{\rulesTitle}{%
	\noindent%
	\color{primary}\setbox\formbox\hbox{\addfontfeature{LetterSpace=-1.0}GESTATTEN,\,}\usebox\formbox%
...
\renewcommand{\settingTitle}{%
	\noindent%
	\color{primary}\setbox\formbox\hbox{\parbox[b]{6cm}{\fontsize{11.0pt}{14pt}\selectfont\addfontfeature{LetterSpace=-1.0}„Eines Tages, vielleicht auch nie, werde \\ich dich bitten, diesen Flyer zu spielen.“}}\usebox\formbox%
